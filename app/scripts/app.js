// Quick work-around for preventing Object.defineProperty() calls which are not (fully) supported in IE.
Object.definePropertyMethods = function(context, name, handlers) {
  context[name] = function() {
    if (arguments.length < 1) {
      return handlers.get.call(this);
    }
    return handlers.set.apply(this, arguments);
  };
}
...
// Needs to be in a wrapper function to prevent async loading issues.
function addRaphaelExtensions() {
...
Object.definePropertyMethods(DDGame.prototype, "ap", {
  get: function() {
    return this.bars.getAP();
  },
  set: function(v) {
    this.bars.setAP(v);
  }
...
Object.definePropertyMethods(DDGame.prototype, "xp", {
  get: function() {
    return this.bars.getXP();
  },
  set: function(v) {
    this.bars.setXP(v);
  }
...
Object.definePropertyMethods(DDGame.prototype, "level", {
  get: function() {
    return this.bars.getLevel();
  }
});

Object.definePropertyMethods(DDGame.prototype, "money", {
  get: function() {
    return this.bars.getMoney();
  },
  set: function(v) {
    this.bars.setMoney(v);
  }
});

Object.definePropertyMethods(DDGame.prototype, "profiles", {
  get: function() {
    return this.bars.getProfiles();
  },
  set: function(v) {
    this.bars.setProfiles(v);
  }
});
...
Object.definePropertyMethods(DBView.prototype, "_tokens", {
  get: function() {
    if (this.profiles) {
      return this.profiles.getElements();
    } else {
      return new Array();
    }
  }
...
// Moved into RequireJS config in main.js
